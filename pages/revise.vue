    ...
    <el-container>
      ...
      <el-main>
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item class="breadcrumb nowLocation" :to="{ path: '/revise' }">修改项目</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-form
          ...
          label-width="130px"
          label-position="left"
          class="demo-ruleForm revise-form"
        >
          <el-form-item label="一级类目" prop="statement">
            <el-select v-model="ruleForm.statement" placeholder="请选择一级类目">
              <el-option label="RA" value="notState"></el-option>
              <el-option label="G" value="willState"></el-option>
              <el-option label="猎头" value="stated"></el-option>
            </el-select>
          </el-form-item>

          <el-form-item label="二级类目" prop="statement">
            <el-select v-model="ruleForm.statement" placeholder="请选择二级类目">
              <el-option label="RA" value="notState"></el-option>
              <el-option label="G" value="willState"></el-option>
              <el-option label="猎头" value="stated"></el-option>
            </el-select>
          ...
          <el-form-item label="工期" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入工期"></el-input>
          </el-form-item>
          <el-form-item label="项目名称" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入项目名称"></el-input>
          </el-form-item>
          <el-form-item label="预计收入金额/元" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入预计收入金额/元"></el-input>
          </el-form-item>
          <el-form-item label="预计支出金额/元" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入预计支出金额/元"></el-input>
          </el-form-item>
          ...
          <el-form-item label="项目员工工时" prop="name">
            <span @click="setWorkTime()" class="setTime">设置工时</span>
            <el-input v-model="ruleForm.name" placeholder="请输入员工工时"></el-input>
          </el-form-item>
          <el-form-item label="项目描述" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入项目描述"></el-input>
          </el-form-item>
            <el-form-item class="button-wrap">
            <el-button @click="resetForm('ruleForm')">取消</el-button>
            <el-button type="primary" @click="submitForm('ruleForm')">保存项目</el-button>
          </el-form-item>
        </el-form>
      </el-main>
    </el-container>
